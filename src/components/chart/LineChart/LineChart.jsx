          ...
          <li className="ml-2">
            <button
              ...
              className={`inline-block p-2 rounded-t-lg border-b-2 border-transparent ${
                activeButton.title === "Sales"
                  ? "text-mainColor-dark border-mainColor-dark dark:text-mainColor dark:border-mainColor"
            ...
            <button
              ...
              className={`inline-block p-2 rounded-t-lg border-b-2 border-transparent ${
                activeButton.title === "Orders"
                  ? "text-customRed border-customRed dark:text-customRed dark:border-customRed"
                  : "hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"
              }  focus:outline-none`}
            >
              {t("Orders")}
