              ...
              <li className="relative" key={route.name}>
                <NavLink
                  ...
                  className={({ isActive }) => {
                    ...
                    return `flex gap-2 px-6 py-5 items-center w-full text-base font-bold transition-colors duration-150 ${isActive || additionalActive ? "text-mainColor dark:text-gray-200" : "hover:text-mainColor dark:hover:text-gray-200"
                      }`;
                  }}
                  rel="noreferrer"
                >
                    ...
                    return (
                      <>
                        ...
                        {typeof route.icon === "string" ? (
                          <img src={route.icon} alt={`${route.name} Icon`} className="w-6 h-6 fill-slate-400 stroke-slate-100" />
                        ) : (
