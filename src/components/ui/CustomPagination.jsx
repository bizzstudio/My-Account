              ...
              <React.Fragment key={index}>
                {page === '...' ? (
                  ...
                  <button
                    ...
                    className={`inline-flex items-center justify-center px-3 py-1 min-w-[2rem] text-sm font-medium rounded-md focus:outline-none focus:ring-[1px] focus:ring-mainColor ${
                      page === currentPage 
